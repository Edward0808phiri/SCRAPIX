...
const REGULATORS = [
  ...
  { name: 'FSS Korea - Press Releases', region: 'KR', url: 'https://english.fss.or.kr/eng/bbs/B0000211/list.do?menuNo=400010', linkContains: '/B0000211/view.do' },
  { name: 'FSS Korea - Rule Changes', region: 'KR', url: 'https://english.fss.or.kr/eng/bbs/B0000210/list.do?menuNo=400081', linkContains: '/B0000210/view.do' },
...
(async () => {
  ...
  for (const reg of regs) {
    process.stdout.write(`[${reg.region}] ${reg.name}${reg.rss ? ' (rss)' : reg.sitemap ? ' (sitemap)' : ''}... `);
